...
exports.voiceAsk = async (req, res) => {
	...
	const voiceInstruction = [
		...
		"",
		"⚠️ OVERRIDE du format générique : pour la voix, IGNORE complètement le format '## Meilleure option / - Durée / - Départ / - Arrivée / - Correspondances' du prompt système. Ce format est interdit ici (la carte iOS affichera les vrais détails du trajet ensuite).",
		"",
		...
		"   - Demande d'itinéraire SANS trajet calculé dans le contexte : 1-2 phrases courtes du type 'Je te cherche un itinéraire vers <lieu>, je te l'ouvre sur la carte.' INTERDIT d'inventer une durée, des correspondances, des lignes ou des arrêts.",
