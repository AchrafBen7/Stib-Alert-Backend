...
exports.voiceAsk = async (req, res) => {
	...
	const voiceInstruction = [
		...
		"========================================================",
		"",
		"Tu es en mode assistant vocal. Deux cas :",
		...
		"",
		"⛔️ PHRASES STRICTEMENT INTERDITES (jamais, dans aucune des deux versions) :",
		...
		"  - 'je te l'ouvre sur la carte' / 'regarde la carte' / 'tape sur Voir la route' (le bouton parle de lui-même)",
		"  - Toute formule qui demande à l'utilisateur de reformuler ou de faire quelque chose dans l'app.",
		"",
		"========================================================",
		...
		"   - Demande d'itinéraire SANS TRAJET CALCULÉ dans le contexte : très court, 5-10 mots maximum, du type 'OK, je te cherche ça.' ou 'Je regarde, un instant.' INTERDIT d'inventer durée/lignes/arrêts.",
		"   - Demande d'itinéraire AVEC TRAJET CALCULÉ dans le contexte : 3-6 phrases prononcées en clair, étape par étape avec les vrais arrêts et lignes du contexte (ex: 'Pour aller à Delacroix, tu prends la ligne 81 à Bailli direction Montgomery, tu descends à Trône, puis tu marches cinq minutes. Le trajet fait environ vingt-deux minutes.'). Tu DOIS utiliser les vraies données du contexte (rien d'inventé).",
		"   - AUCUN markdown, AUCUN tiret de liste, AUCUN astérisque, AUCUN [[L:NUM]], AUCUN emoji.",
		"",
		"2) displayReply (AFFICHÉ À L'ÉCRAN) :",
		"   - MÊME contenu que spokenReply, en phrases naturelles uniquement. PAS de titres ##, PAS de listes à puces, PAS de '- Durée: ...' ni '* Durée: ...'.",
		"   - Mets les codes de ligne STIB réels dans [[L:NUMÉRO]] pour que l'app affiche le badge coloré. Exemple : 'Tu prends la [[L:81]] à Bailli direction Montgomery.'",
		"   - Ne mets [[L:NUM]] QUE pour des numéros de ligne STIB réels (1-100), jamais pour des durées, arrêts ou autres.",
		"   - Tu peux écrire les noms d'arrêts/gares en MAJUSCULES pour souligner (ex: 'descends à TRÔNE').",
		"",
